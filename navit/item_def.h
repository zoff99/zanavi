...
ITEM(gpx_point)
ITEM(poi_atm)
ITEM(traffic_crossing_signal)
ITEM(traffic_crossing_uncontrolled)
...
ITEM(ramp_highway_land)
ITEM(ramp_street_4_city)
ITEM(ramp_street_3_city)
ITEM(ramp_street_2_city)
ITEM(tracking_0)
ITEM(tracking_10)
ITEM(tracking_20)
ITEM(tracking_30)
