...
public abstract class AppIntro extends AppIntroBase {
     ...
     *
     */
    public void setNextArrowColor(final int color) {
     ...
     */
    public void setSkipText(final CharSequence text) {
     ...
     * @param text your text
     */
    public void setDoneText(final CharSequence text) {
     ...
     */
    public void setColorDoneText(final int colorDoneText) {
        TextView doneText = (TextView) findViewById(R.id.done);
     ...
     */
    public void setColorSkipButton(final int colorSkipButton) {
