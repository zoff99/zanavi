...
public class EasyPermissions
{
	 ...
	 *             if the calling Activity does not implement {@link PermissionCallbacks}.
	 */
	...
	/**
	 * Calls {@link #checkDeniedPermissionsNeverAskAgain(Object, String, int, int, DialogInterface.OnClickListener, List)} with a {@code null} argument for the negatieb buttonOnClickListener.
	 */
	public static boolean checkDeniedPermissionsNeverAskAgain(final Object object, String rationale, int positiveButton, int negativeButton, List<String> deniedPerms)
	{
	 ...
	 * returned to the app, {@link Activity#onActivityResult(int, int, Intent)} or {@link Fragment#onActivityResult(int, int, Intent)} or {@link android.app.Fragment#onActivityResult(int, int, Intent)} will be called with {@value #SETTINGS_REQ_CODE} as requestCode
	 * <p>
	 * NOTE: use of this method is optional, should be called from {@link PermissionCallbacks#onPermissionsDenied(int, List)}
	 * 
	 * @param object
	 *            the calling Activity or Fragment.
	 * @param deniedPerms
	 ...
	 *            negative button on click listener. If the
	 ...
	 */
	public static boolean checkDeniedPermissionsNeverAskAgain(final Object object, String rationale, int positiveButton, int negativeButton, DialogInterface.OnClickListener negativeButtonOnClickListener, List<String> deniedPerms)
	{
