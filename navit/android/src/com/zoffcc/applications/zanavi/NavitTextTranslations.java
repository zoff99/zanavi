...
public class NavitTextTranslations
{
	...
	public static void init()
	{
		...
		v = new String[] { "en", "buy Donate Version", "de", "Donate Version kaufen" };
		p(k, v);
		...
		v = new String[] { "en", "buy large-map Donate Version", "de", "large-map Donate Version kaufen" };
		p(k, v);
		...
		v = new String[] { "en", "Donate with the offcial Donate App", "de", "offizielle Spenden App starten" };
		p(k, v);
		k = "ZANavi Donate Version already installed";
		v = new String[] { "en", "ZANavi Donate Version already installed", "de", "Donate Version ist bereits installiert" };
		p(k, v);
		k = "ZANavi large map Donate Version already installed";
		v = new String[] { "en", "ZANavi large map Donate Version already installed", "de", "large-map Donate Version ist bereits installiert" };
		p(k, v);
		k = "starting Donate App";
		v = new String[] { "en", "starting Donate App", "de", "offizielle Spenden App wird gestartet" };
		p(k, v);
		...
		p(k, v);
		k = "downloading";
		v = new String[] { "en", "downloading", "ca", "descarregant", "ar", "تحميل", "pt", "baixando", "pt_BR", "baixando", "zh", "正在下载", "zh_HK", "下載", "cs", "stahování", "nl", "downloaden", "fr", "téléchargement", "el", "λήψη", "hu", "letöltés", "it", "scaricamento", "pl", "Pobieranie", "sk", "Sťahuje sa", "es", "descargando" };
		p(k, v);
		k = "ETA";
		...
		p(k, v);
		k = "checking map ...";
		v = new String[] { "en", "checking map ...", "de", "prüfe Karte ...", "hu", "Térkép ellenőrzése..." };
		p(k, v);
		k = "MD5 mismatch";
		...
		v = new String[] { "en", "Error downloading index!", "de", "Fehler beim index download!", "hu", "Hiba az index letöltése közben!", "pl", "Błąd ładowania indeksu!", "ru", "Ошибка при загрузке индекса!" };
		p(k, v);
		k = "Index download";
		v = new String[] { "en", "Index download", "hu", "Index letöltése" };
		p(k, v);
		k = "downloading indexfile";
		v = new String[] { "en", "downloading indexfile", "de", "lade indexfile", "hu", "Indexfile letöltése folyamatban", "pl", "ładowanie pliku indeksu" };
		p(k, v);
		k = "ready";
		...
		v = new String[] { "en", "Creating outputfile\nthis can take a long time", "ar", "إنشاء مخرجات لملف، تأخذ وقت طويل", "pt", "Criando arquivo, pode levar alguns minutos", "pt_BR", "Criando arquivo, pode levar alguns minutos", "zh", "正在创建输出文件，可能耗时较长", "zh_HK", "建立輸出檔，要很長時間", "cs", "Vytvářím výstupní soubor, bude to trvat déle", "nl", "Bestand wordt gemaakt, kan even duren", "fr", "Création du fichier de sortie, très long", "de", "Kartendatei anlegen\nDas kann etwas dauern", "el",
				"Δημιουργία εξαγόμενου αρχείου, αρκετός χρόνος", "hu", "Kimeneti adatállomány előállítása,\nsokáig eltarthat, kérem, várjon!", "it", "Creando outputfile, molto tempo", "pl", "Tworzę plik wyjściowy, długi czas oczekiwania", "ru", "Создание выходного файла, долго", "sk", "Vytvára sa výstupný súbor" };
		p(k, v);
		...
		v = new String[] { "en", "driving to Home Location", "de", "navigiere zur Heimadresse" };
		p(k, v);
		k = "No Home Location set";
		v = new String[] { "en", "No Home Location set", "de", "keine Heimadresse gesetzt" };
		p(k, v);
		k = "Share Destination";
		v = new String[] { "en", "Share Destination", "de", "Teile Ziel", "hu", "Cél megosztása" };
		p(k, v);
		k = "Share my Location";
		v = new String[] { "en", "Share my Location", "de", "teile Standort" };
		p(k, v);
		...
		v = new String[] { "en", "address search (offline)", "ar", "بحث عنوان (غير متصل)", "pt", "procurar endereço (offline)", "pt_BR", "procurar endereço (offline)", "zh", "搜索地点（离线）", "zh_HK", "搜尋地址 (網下)", "cs", "Hledání (offline)", "nl", "adres zoeken (offline)", "fr", "recherche (offline)", "de", "Adressensuche (offline)", "el", "αναζήτηση (χωρίς σύνδεση)", "hu", "Címkeresés (offline)", "it", "cerca indirizzo (offline)", "pl", "wyszukaj adres (offline)", "ru", "адресный поиск (офлайн)",
				"sk", "Hľadať adresu (offline)", "es", "Buscar dirección (offline)" };
		p(k, v);
		...
		p(k, v);
		k = "Search";
		v = new String[] { "en", "Search", "ca", "Cerca", "ar", "بحث", "pt", "Procurar", "pt_BR", "Procurar", "zh", "搜索", "zh_HK", "搜尋", "cs", "Hledání", "nl", "Zoek", "fr", "Chercher", "de", "suchen", "el", "Αναζήτηση", "hu", "Keresés", "it", "Cerca", "pl", "Wyszukaj", "sk", "Hľadať", "es", "Buscar" };
		p(k, v);
		k = "downloading map";
		v = new String[] { "en", "downloading map", "de", "lade Karte" };
		p(k, v);
		k = "Zoom to Route";
		...
		v = new String[] { "en", "Donate with Google Play", "de", "Spenden mit Google Play" };
		p(k, v);
		k = "Donate with Bitcoin";
		v = new String[] { "en", "Donate with Bitcoin", "de", "Spenden mit Bitcoin" };
		p(k, v);
		k = "exit navit";
		...
		p(k, v);
		k = "Announcer On";
		v = new String[] { "en", "Announcer On", "ar", "فتح الإخباري", "pt", "Locutor ativado", "pt_BR", "Locutor ativado", "zh", "语音播报已启用", "zh_HK", "Announcer 開", "cs", "Zapnout ohlašování", "nl", "spraak aan", "fr", "Voix On", "de", "Ansagen einschalten", "el", "Εκφώνηση Ανοικτή", "hu", "Hangbemondás be", "it", "Annunciatore Acceso", "pl", "Włącz komunikaty", "ru", "Включить голос", "sk", "Hlásateľ Zap" };
		p(k, v);
		k = "Announcer Off";
		...
		p(k, v);
		k = "show Maps age";
		v = new String[] { "en", "show Maps age", "pt_BR", "mostrar idade do mapa", "zh_HK", "顯示地圖建立日期表", "de", "Karten Erstelldatum", "el", "Εμφάνιση παλαιότητας χάρτη", "hu", "Térkép aktualitása", "pl", "Pokaż wiek map", "sk", "Zobraziť vek máp" };
		p(k, v);
		k = "Coord Dialog";
		v = new String[] { "en", "Coord Dialog", "pt_BR", "Coordenadas", "de", "Koordinaten eingeben", "el", "Συντεταγμένες", "hu", "Koordináta-párbeszéd", "pl", "Wprowadź współrzędne", "sk", "Zadanie súradníc" };
		p(k, v);
		k = "add Traffic block";
		v = new String[] { "en", "add Traffic block", "de", "Baustelle markieren", "el", "προσθήκη μποτιλιαρίσματος", "hu", "Forgalmi akadály hozzáadása", "pl", "Zaznacz blokadę ruchu", "sk", "Pridať prekážku v premávke" };
		p(k, v);
		k = "clear Traffic blocks";
		v = new String[] { "en", "clear Traffic blocks", "de", "alle Baustellen entfernen", "el", "καθαρισμός μποτιλιαρισμάτων", "hu", "Forgalmi akadály eltávolítása", "pl", "Skasuj wszystkie blokady ruchu", "sk", "Zmazať prekážky v premávke" };
		p(k, v);
		k = "convert GPX file";
		...
		p(k, v);
		k = "clear GPX map";
		v = new String[] { "en", "clear GPX map", "de", "GPX routen entfernen", "el", "καθαρισμός χάρτη GPX", "hu", "GPX térkép törlése", "sk", "Zmazať GPX mapu" };
		p(k, v);
		k = "Demo Vehicle";
		...
		p(k, v);
		k = "toggle Routegraph";
		v = new String[] { "en", "toggle Routegraph", "de", "Routegraph anzeigen", "hu", "Útvonal gfáf ki/be" };
		p(k, v);
		k = "send feedback";
		v = new String[] { "en", "send feedback", "de", "feedback senden", "hu", "Vélemény küldése" };
		p(k, v);
		k = "online Help";
		...
		p(k, v);
		k = "Share";
		v = new String[] { "en", "Share", "de", "Teilen", "hu", "Megosztás" };
		p(k, v);
		k = "Stop Navigation";
		...
		p(k, v);
		k = "Meeting Point";
		v = new String[] { "en", "Meeting Point", "de", "Treffpunkt", "hu", "Találkozás helye" };
		p(k, v);
		k = "my Location";
		v = new String[] { "en", "my Location", "de", "Standort" };
		p(k, v);
		...
		p(k, v);
		k = "No search string";
		v = new String[] { "en", "No search string", "de", "Kein Suchtext", "hu", "Nincs keresési szöveg" };
		p(k, v);
		...
		p(k, v);
		k = "new Waypoint";
		v = new String[] { "en", "new Waypoint", "ar", "نقطة طريق جديدة", "pt", "novo ponto de partida", "pt_BR", "novo ponto de partida", "zh", "新建路径点", "zh_HK", "新 Waypoint", "cs", "nový waypoint", "nl", "nieuw routepunt", "fr", "nouvelle destination", "de", "neues Zwischenziel", "el", "νέο σημείο", "hu", "Új útpont", "pl", "Nowy punkt", "ru", "Новая Точка", "sk", "nový cestovný bod" };
		p(k, v);
		k = "there was a problem with sending feedback";
		v = new String[] { "en", "there was a problem with sending feedback", "de", "Problem beim senden von feedback", "hu", "A vélemény küldése közben hiba lépett fel" };
		p(k, v);
		...
		v = new String[] { "en", "Possibly not enough space on your device!", "de", "Möglicherweise ist nicht genung Platz vorhanden!", "el", "Πιθανόν όχι αρκετός χώρος στη συσκευή", "hu", "Feltehetöen nincs elég hely az eszközön!", "pl", "Prawdopodobnie brak miejsca na Twoim urządzeniu!", "sk", "Pravdepodobne nedostatok voľného miesta vo Vašom zariadení!" };
		p(k, v);
		k = "device space";
		v = new String[] { "en", "device space", "de", "Speicherplatz", "el", "χώρος στη συσκευή", "hu", "Eszköz szabad tárhely", "sk", "Voľné miesto v zariadení" };
		p(k, v);
		k = "Cancel";
		v = new String[] { "en", "Cancel", "de", "Abbrechen", "hu", "Mégsem" };
		p(k, v);
		k = "Send feedback via email ...";
		v = new String[] { "en", "Send feedback via email ...", "de", "Feedback per Email senden ..." };
		p(k, v);
		k = "Please press BACK again to Exit";
		v = new String[] { "en", "Please press BACK again to Exit", "de", "nochmal BACK drücken um App zu beenden" };
		p(k, v);
		k = "google search API is not working at this moment, try offline search";
		v = new String[] { "en", "google search API is not working at this moment, try offline search", "de", "Google Suche funktioniert im Moment nicht, bitte offline Suche verwenden", "hu", "A Google keresö API nem müködik, próbáld késöbb" };
		p(k, v);
		k = "Destination set";
		v = new String[] { "en", "Destination set", "de", "Ziel gesetzt", "el", "Ορισμός προορισμού", "hu", "Cél beadva", "sk", "Cieľ bol určený" };
		p(k, v);
		k = "No route found / Route blocked";
		v = new String[] { "en", "No route found / Route blocked", "de", "keine Route gefunden / blockiert", "el", "Δεν βέθηκε διαδρομή / μπλοκαρισμένη διαδρομή", "hu", "Nem található útvonal / útvonal lezárva", "pl", "Nie znaleziono drogi / Droga zablokowana", "sk", "Nenašla sa žiadna trasa / Trasa zablokovaná", "es", "No se encontró una ruta / Ruta bloqueada" };
		p(k, v);
		k = "Building route path";
		v = new String[] { "en", "Building route path", "de", "generiere Route Path", "hu", "Útvonal kiszámolása", "it", "Calcolando l'itinerario", "pl", "Generowanie trasy" };
		p(k, v);
		k = "Building route graph";
		v = new String[] { "en", "Building route graph", "de", "generiere Route Graph", "hu", "Útvonal ábra kiszámolása", "pl", "Generowanie wykresu trasy", "sk", "Zostavuje sa graf trasy" };
		p(k, v);
		k = "downloading, please wait ...";
		v = new String[] { "en", "downloading, please wait ...", "de", "laden, bitte warten ...", "hu", "Letöltés ... kérlek, várj!" };
		p(k, v);
		...
		v = new String[] { "en", "set as Home Location", "de", "als Heimadresse setzen" };
		p(k, v);
		k = "Rename Destination";
		v = new String[] { "en", "Rename Destination", "ar", "إعادة تسمية المقصد", "pt", "Renomear Destino", "pt_BR", "Renomear Destino", "zh", "重命名目的地", "zh_HK", "重新命名目的地", "cs", "Přejmenovat cíl", "nl", "Bestemming hernoemen", "fr", "Renommer la destination", "de", "Ziel umbenennen", "el", "Μετονομασία Προορισμού", "hu", "Cél átnevezése", "it", "Rinomina Destinazione", "pl", "Zmień nazwę celu", "sk", "Premenovať cieľ", "es", "Renombrar destino" };
		p(k, v);
		...
		p(k, v);
		k = "Housenumber";
		v = new String[] { "en", "Housenumber", "de", "Hausnummer", "hu", "Házszám", "pl", "Numer domu" };
		p(k, v);
		k = "partial match";
		...
		p(k, v);
		k = "last searches";
		v = new String[] { "en", "last searches", "de", "letzte Eingaben" };
		p(k, v);
		k = "Streetname";
		v = new String[] { "en", "Streetname", "de", "Straße", "hu", "Utcanév" };
		p(k, v);
		k = "Town";
		v = new String[] { "en", "Town", "de", "Ort", "hu", "Város" };
		p(k, v);
		k = "Address or POI-Name";
		v = new String[] { "en", "Address or POI-Name", "de", "Adresse oder POI-Name", "hu", "Cím vagy POI-név" };
		p(k, v);
		k = "Stop map download?";
		v = new String[] { "en", "Stop map download?", "de", "Kartendownload beenden?", "hu", "Térkép letöltés leállítása" };
		p(k, v);
		k = "press HOME to download in the background";
		v = new String[] { "en", "press HOME to download in the background", "de", "drücke HOME um die Karten im Hintergrund zu laden" };
		p(k, v);
		k = "Yes";
		v = new String[] { "en", "Yes", "de", "Ja", "hu", "Igen" };
		p(k, v);
		k = "No";
		v = new String[] { "en", "No", "de", "Nein", "hu", "Nem" };
		p(k, v);
		k = "Enter your Feedback text";
		v = new String[] { "en", "Enter your Feedback text", "de", "Feedbacktext eingeben", "hu", "Vélemény beírása" };
		p(k, v);
		k = "send";
		v = new String[] { "en", "send", "de", "senden", "hu", "Küldés" };
		p(k, v);
		k = "copy Bitcoinaddress to Clipboard";
		v = new String[] { "en", "copy Bitcoinaddress to Clipboard", "de", "Bitcoin Adresse in Zwischenablage kopieren" };
		p(k, v);
		k = "send Bitcoinaddress and QR Code as Email";
		v = new String[] { "en", "send Bitcoinaddress and QR Code as Email", "de", "Bitcoin Adresse und QR Code als Email senden" };
		p(k, v);
		k = "Donate with Bitcoin Wallet App";
		v = new String[] { "en", "Donate with Bitcoin Wallet App", "de", "Spende mit Bitcoin Wallet App" };
		p(k, v);
		k = "ZANavi Donation with Bitcoin";
		v = new String[] { "en", "ZANavi Donation with Bitcoin", "de", "ZANavi Spenden mit Bitcoin" };
		p(k, v);
		k = "Bitcoin address";
		v = new String[] { "en", "Bitcoin address", "de", "Bitcoin Adresse" };
		p(k, v);
		k = "generate QR code";
		v = new String[] { "en", "generate QR code", "de", "generiere QR Code" };
		p(k, v);
		k = "Send Bitcoin address to email ...";
		v = new String[] { "en", "Send Bitcoin address to email ...", "de", "sende Bitcoin Adresse als Email ..." };
		p(k, v);
		k = "Bitcoinaddress copied to Clipboard";
		v = new String[] { "en", "Bitcoinaddress copied to Clipboard", "de", "Bitcoin Adresse in Zwischenablage kopiert" };
		p(k, v);
		...
		p(k, v);
		k = "Click to talk";
		v = new String[] { "en", "Click to talk", "de", "zum sprechen drücken", "hu", "Beszélgetéshez katt ide" };
		p(k, v);
		k = "Voice Search, speak your Destination";
		v = new String[] { "en", "Voice Search, speak your Destination", "de", "Sprachsuche", "hu", "Hang alapú keresés, mondd a célt" };
		p(k, v);
		k = "Google Speechrecognition not found";
		v = new String[] { "en", "Google Speechrecognition not found", "de", "Google Text-in-Sprache nicht installiert", "hu", "Nem találom a Google beszédfelismeröt!" };
		p(k, v);
		k = "you said:";
		v = new String[] { "en", "you said:", "de", "Sie sagten:", "hu", "Ezt mondtad:" };
		p(k, v);
		k = "searching for the location";
		v = new String[] { "en", "searching for the location", "de", "Ort wird gesucht", "hu", "Hely keresése" };
		p(k, v);
		k = "Find Destination";
		v = new String[] { "en", "Find Destination", "de", "Ort finden", "hu", "Hely keresése" };
		p(k, v);
		k = "Google did not find this location. Please search again";
		v = new String[] { "en", "Google did not find this location. Please search again", "de", "Dieser Ort wurde von Google nicht gefunden. Bitte versuchen Sie es nochmals", "hu", "A Google nem találja azt a helyet. Keress újra!" };
		p(k, v);
		k = "What's here";
		v = new String[] { "en", "What's here", "de", "Was ist hier", "el", "Τι είναι εδώ", "hu", "Mi van itt?", "pl", "Co tu jest", "sk", "Čo je tu" };
		p(k, v);
		// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
		// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
		// change those in https://translations.launchpad.net/zanavi
