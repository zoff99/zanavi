...
public class NavitTextTranslations
{
	...
	public static void init()
	{
		...
		// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
		k = "Donate";
		v = new String[] { "en", "Donate", "fr", "Faites un don", "de", "Spenden", "el", "Δωρεά" };
		p(k, v);
		k = "buy Donate Version";
		v = new String[] { "en", "buy Donate Version", "fr", "Achetez la version payante", "de", "Donate Version kaufen", "el", "αγορά έκδοσης Με δωρεά", "es", "Quiero donar para la versión" };
		p(k, v);
		k = "buy large-map Donate Version";
		v = new String[] { "en", "buy large-map Donate Version", "fr", "Achetez la version haute résolution payante", "de", "large-map Donate Version kaufen", "el", "αγορά έκδοσης ολόκληρου-χάρτη με Δωρεά", "es", "Quiero donar para adquirir una versión grande del mapa" };
		p(k, v);
		k = "Donate with the offcial Donate App";
		v = new String[] { "en", "Donate with the offcial Donate App", "de", "offizielle Spenden App starten", "el", "Δωρεά μέσω της επίσημης εφρμογής Δωρεάς", "es", "Donar para la App oficial" };
		p(k, v);
		...
		v = new String[] { "en", "Donate any Amount with the official Donate App", "de", "Einen beliebigen Betrag mit der offiziellen Donate App spenden" };
		p(k, v);
		k = "ZANavi Donate Version already installed";
		v = new String[] { "en", "ZANavi Donate Version already installed", "de", "Donate Version ist bereits installiert", "el", "Η έκδση του ZANavi με Δωρεά είναι ήδη εγκατεστημένη", "es", "La versión donada de Zanavi, ya está instalada" };
		p(k, v);
		k = "ZANavi large map Donate Version already installed";
		v = new String[] { "en", "ZANavi large map Donate Version already installed", "de", "large-map Donate Version ist bereits installiert", "el", "Η έκδοση ολόκληρου-χάρτη με Δωρεά είναι ήδη εγκατεστημένη", "es", "La versión larga del mapa donado, ya está instalado" };
		p(k, v);
		k = "There is no Donate App on Amazon-device";
		v = new String[] { "en", "There is no Donate App on Amazon-device", "de", "Auf dem Amazongerät gibt es keine Donate App", "el", "Δεν υπάρχει εφαρμογή Δωρεάς στή συσκευή-Amazon" };
		p(k, v);
		k = "starting Donate App";
		v = new String[] { "en", "starting Donate App", "de", "offizielle Spenden App wird gestartet", "el", "έναρξη εφαρμογής δωρεάς", "es", "empezando a Donar a app" };
		p(k, v);
		k = "Map Preview";
		v = new String[] { "en", "Map Preview", "fr", "Aperçu de la carte", "de", "Kartenvorschau", "el", "Προεπισκόπηση χάρτη" };
		p(k, v);
		k = "Use as destination";
		v = new String[] { "en", "Use as destination", "ar", "اختر مقصد", "pt", "Usar como destino", "pt_BR", "Usar como destino", "zh", "设为目的地", "zh_HK", "以其為目的地", "cs", "Použít jako cíl", "nl", "gebruik als bestemming", "fr", "Utiliser comme destination", "de", "als Ziel setzen", "el", "Χρήση ως προορισμός", "hu", "Állítsd be célként", "it", "Usa come destinazione", "pl", "Użyj jako celu", "ru", "Использовать как пункт назначения", "sk", "Použiť ako cieľ", "es", "Usar como destino" };
		p(k, v);
		k = "back";
		...
		v = new String[] { "en", "show destination on map", "ca", "mostrar destinació al mapa", "ar", "عرض المقصد علي الخريطة", "pt", "mostrar destino no mapa", "pt_BR", "mostrar destino no mapa", "zh", "在地图上显示目的地", "zh_HK", "於地圖顯示目的地", "cs", "zobrazit cíl na mapě", "nl", "toon bestemming op kaart", "fr", "voir la destination sur la carte", "de", "Ziel auf Karte anzeigen", "el", "εμφάνιση προορισμού στο χάρτη", "hu", "Mutasd az úticélt a térképen", "it", "mostra destinazione sulla mappa", "pl",
				"pokaż cel na mapie", "ru", "показать пункт назначения на карте", "sk", "Zobraziť cieľ na mape", "es", "mostrar destino en el mapa" };
		p(k, v);
		k = "touch map to zoom";
		v = new String[] { "en", "touch map to zoom", "ca", "toqueu el mapa per ampliar", "ar", "المس الشاشة للتكبير", "pt", "toque o mapa para ampliar", "pt_BR", "toque o mapa para ampliar", "zh", "点击缩放", "zh_HK", "觸碰地圖放大", "cs", "pro přiblížení se dotkněte mapy", "nl", "raak kaart aan om te zoomen", "fr", "touchez la carte pour zoomer", "de", "auf Karte drücken zum zoomen", "el", "αγγίξτε το χάρτη για εστίαση", "hu", "Érintsd meg a térképet nagyításhoz (zoom)", "it",
				"tocca la mappa per ingrandire", "pl", "dotknij mapy aby przybliżyć", "ru", "нажать на карту, чтобы увеличить", "sk", "Ťuknite na mapu pre priblíženie", "es", "toque el mapa para ampliar" };
		p(k, v);
		...
		v = new String[] { "en", "Error downloading map!", "ca", "Error descarregant mapa!", "ar", "خطأ أثناء تحميل الخريطة!", "pt", "Erro ao baixar o mapa!", "pt_BR", "Erro ao baixar o mapa!", "zh", "下载地图出错！", "zh_HK", "下載地圖時出錯！", "cs", "Chyba při stahování mapy!", "nl", "Fout tijdens downloaden!", "fr", "Erreur de téléchargement de carte!", "de", "Fehler beim Kartendownload!", "el", "Σφάλμα λήψης χάρτη!", "hu", "Hiba térképletöltés közben!", "it", "Errore scaricamento le mappe!", "pl",
				"Błąd przy pobieraniu map", "ru", "Ошибка загрузки карты!", "sk", "Chyba počas sťahovania mapy", "es", "Error al descargar el mapa" };
		p(k, v);
		k = "Mapdownload";
		v = new String[] { "en", "Mapdownload", "ar", "تحميل الخريطة", "pt", "Baixar mapa", "pt_BR", "Baixar mapa", "zh", "地图下载", "zh_HK", "地圖下載", "cs", "Stahování mapy", "nl", "kaart download", "fr", "télécharchez carte", "de", "Kartendownload", "el", "Λήψη χάρτη", "hu", "Térképletöltés", "it", "Scarica mappa", "pl", "Pobieranie map", "ru", "загрузка карты", "sk", "Sťahovanie mapy", "es", "Descargar mapa" };
		p(k, v);
		k = "downloading";
		v = new String[] { "en", "downloading", "ca", "descarregant", "ar", "تحميل", "pt", "baixando", "pt_BR", "baixando", "zh", "正在下载", "zh_HK", "下載", "cs", "stahování", "nl", "downloaden", "fr", "transfert en cours", "el", "λήψη", "hu", "letöltés", "it", "scaricamento", "pl", "Pobieranie", "sk", "Sťahuje sa", "es", "descargando" };
		p(k, v);
		k = "ETA";
		...
		v = new String[] { "en", "Please download a map", "fr", "Veuillez telecharger une carte", "de", "Bitte eine Karte runterladen", "el", "Παρακαλώ κάντε λήψη ενός χάρτη", "es", "Por favor, descargue un mapa" };
		p(k, v);
		...
		v = new String[] { "en", "driving to Home Location", "de", "navigiere zur Heimadresse", "el", "οδήγηση στο Σπίτι", "es", "conduciendo hacia la ubicación de inicio" };
		p(k, v);
		k = "No Home Location set";
		v = new String[] { "en", "No Home Location set", "de", "keine Heimadresse gesetzt", "el", "Δεν έχει οριστεί τοποθεσία Σπιτιού", "es", "No hay un conjunto de ubicaciones de inicio" };
		p(k, v);
		...
		v = new String[] { "en", "No Index for some Maps", "de", "Kein Indexfile bei manchen Karten" };
		p(k, v);
		k = "Share Destination";
		...
		p(k, v);
		k = "Share my Location";
		v = new String[] { "en", "Share my Location", "de", "teile Standort", "el", "Διαμοιρασμός Τοποθεσίας μου", "es", "Compartir mi ubicación" };
		p(k, v);
		...
		v = new String[] { "en", "address search (offline)", "ar", "بحث عنوان (غير متصل)", "pt", "procurar endereço (offline)", "pt_BR", "procurar endereço (offline)", "zh", "搜索地点（离线）", "zh_HK", "搜尋地址 (網下)", "cs", "Hledání (offline)", "nl", "adres zoeken (offline)", "fr", "recherche d'adresse (hors ligne)", "de", "Adressensuche (offline)", "el", "αναζήτηση (χωρίς σύνδεση)", "hu", "Címkeresés (offline)", "it", "cerca indirizzo (offline)", "pl", "wyszukaj adres (offline)", "ru",
				"адресный поиск (офлайн)", "sk", "Hľadať adresu (offline)", "es", "Buscar dirección (offline)" };
		p(k, v);
		...
		p(k, v);
		k = "downloading map";
		v = new String[] { "en", "downloading map", "de", "lade Karte", "el", "λήψη χάρτη", "es", "descargando el mapa" };
		p(k, v);
		k = "Zoom to Route";
		...
		p(k, v);
		k = "show Maps age";
		v = new String[] { "en", "show Maps age", "pt_BR", "mostrar idade do mapa", "zh_HK", "顯示地圖建立日期表", "nl", "toon ouderdom kaarten", "fr", "Montrer date des cartes", "de", "Karten Erstelldatum", "el", "Εμφάνιση παλαιότητας χάρτη", "hu", "Térkép aktualitása", "pl", "Pokaż wiek map", "sk", "Zobraziť vek máp", "es", "Mostrar la antigüedad de los mapas" };
		p(k, v);
		k = "Coord Dialog";
		v = new String[] { "en", "Coord Dialog", "pt_BR", "Coordenadas", "de", "Koordinaten eingeben", "el", "Συντεταγμένες", "hu", "Koordináta-párbeszéd", "pl", "Wprowadź współrzędne", "sk", "Zadanie súradníc", "es", "Coordinar el diálogo" };
		p(k, v);
		k = "add Traffic block";
		v = new String[] { "en", "add Traffic block", "de", "Baustelle markieren", "el", "προσθήκη μποτιλιαρίσματος", "hu", "Forgalmi akadály hozzáadása", "pl", "Zaznacz blokadę ruchu", "sk", "Pridať prekážku v premávke", "es", "Añadir bloqueo de tráfico" };
		p(k, v);
		k = "clear Traffic blocks";
		v = new String[] { "en", "clear Traffic blocks", "de", "alle Baustellen entfernen", "el", "καθαρισμός μποτιλιαρισμάτων", "hu", "Forgalmi akadály eltávolítása", "pl", "Skasuj wszystkie blokady ruchu", "sk", "Zmazať prekážky v premávke", "es", "Eliminar el bloqueo de tráfico" };
		p(k, v);
		k = "convert GPX file";
		v = new String[] { "en", "convert GPX file", "pt_BR", "converter arquivo GPX", "zh_HK", "轉換成GPX檔案", "de", "GPX file konvertieren", "el", "μετατροπή αρχείου GPX", "hu", "GPX file konverzió", "pl", "Konwertuj plik GPX", "sk", "Skonvertovať GPX súbor", "es", "Convertir fichero GPX" };
		p(k, v);
		k = "replay a ZANavi gps file";
		v = new String[] { "en", "replay a ZANavi gps file", "el", "αναπαραγωγή αρχείου gps ZANavi ξανά" };
		p(k, v);
		k = "clear GPX map";
		v = new String[] { "en", "clear GPX map", "de", "GPX routen entfernen", "el", "καθαρισμός χάρτη GPX", "hu", "GPX térkép törlése", "sk", "Zmazať GPX mapu", "es", "Borrar el mapa GPX" };
		p(k, v);
		k = "Demo Vehicle";
		...
		p(k, v);
		k = "Speech Texts";
		v = new String[] { "en", "Speech Texts", "ar", "خاصية قراءة النصوص", "pt_BR", "Textos falados", "zh", "朗读文本", "zh_HK", "話音文字", "nl", "Gesproken tekst", "de", "Texte für Sprache", "el", "Εκφώνηση Κειμένων", "hu", "Beszéd szövegek", "pl", "Czytaj teksty", "ru", "Речевые Тексты", "sk", "Rečové texty", "es", "Reproduce los textos" };
		p(k, v);
		k = "Nav. Commands";
		...
		p(k, v);
		k = "toggle Routegraph";
		v = new String[] { "en", "toggle Routegraph", "de", "Routegraph anzeigen", "hu", "Útvonal gfáf ki/be", "es", "Conmuta el gráfico de la ruta" };
		p(k, v);
		k = "export Destinations";
		v = new String[] { "en", "export Destinations", "de", "Ziele exportieren", "es", "Exportar la lista de destinos" };
		p(k, v);
		k = "import Destinations";
		v = new String[] { "en", "import Destinations", "de", "Ziele importieren", "es", "Importar la lista de destinos" };
		p(k, v);
		k = "send feedback";
		v = new String[] { "en", "send feedback", "de", "feedback senden", "hu", "Vélemény küldése", "es", "enviar comentarios" };
		p(k, v);
		k = "online Help";
		...
		p(k, v);
		k = "Target in gmaps";
		v = new String[] { "en", "Target in gmaps", "ca", "Destinació a gmaps", "ar", "الهدف في الخريطة", "pt", "Mostrar no gmaps", "pt_BR", "Mostrar no gmaps", "zh", "在谷歌地图中显示", "zh_HK", "用 Google 地圖顯示目標", "nl", "Plaats in gmaps", "de", "zeige in gmaps", "el", "Στόχος στο gmaps", "hu", "Mutasd a célt a GMaps-ben", "pl", "Pokaż w GMaps", "ru", "Текущ. цель в gmaps", "sk", "Cieľ na Google mapách", "es", "Destino en gmaps" };
		p(k, v);
		k = "Share";
		v = new String[] { "en", "Share", "fr", "Partager", "de", "Teilen", "hu", "Megosztás", "es", "Recurso compartido" };
		p(k, v);
		k = "Stop Navigation";
		v = new String[] { "en", "Stop Navigation", "ca", "Atura la navegació", "ar", "وقف الملاحة", "pt", "Parar Navegação", "pt_BR", "Parar Navegação", "zh", "停止导航", "zh_HK", "停止導航", "cs", "Přestat navigovat", "nl", "Stop navigatie", "fr", "Arrêter navigation", "de", "Navigation beenden", "el", "Διακοπή πλοήγησης", "hu", "Navigálás vége", "it", "Interrompi Navigazione", "pl", "Zatrzymaj nawigację", "sk", "Zastaviť navigáciu", "es", "Detener navegación" };
		p(k, v);
		k = "No address found";
		...
		p(k, v);
		k = "Meeting Point";
		v = new String[] { "en", "Meeting Point", "de", "Treffpunkt", "hu", "Találkozás helye", "es", "Punto de encuentro" };
		p(k, v);
		k = "my Location";
		v = new String[] { "en", "my Location", "de", "Standort", "es", "mi Localización" };
		p(k, v);
		...
		p(k, v);
		k = "No search string";
		v = new String[] { "en", "No search string", "de", "Kein Suchtext", "hu", "Nincs keresési szöveg", "es", "Sin cadena de búsqueda" };
		p(k, v);
		...
		v = new String[] { "en", "there was a problem with sending feedback", "de", "Problem beim senden von feedback", "hu", "A vélemény küldése közben hiba lépett fel", "es", "Hubo un problema con el envío de comentarios" };
		p(k, v);
		...
		v = new String[] { "en", "getting search results", "ar", "عرض نتيجة البحث", "pt", "obtendo resultados da busca", "pt_BR", "obtendo resultados da busca", "zh", "正在获取搜索结果", "zh_HK", "取得搜尋結果", "cs", "Získávám výsledky hledání", "nl", "haalt zoekresultaten op", "fr", "recherche en cours", "de", "lade Suchergebnisse", "el", "λήψη αποτελεσμάτων αναζήτησης", "hu", "Eredmények keresése", "it", "ricevendo risultati ricerca", "pl", "pobieranie wyników wyszukiwania", "ru",
				"получить результат поиска", "sk", "Získava sa výsledok hľadania", "es", "obteniendo resultados de la búsqueda" };
		p(k, v);
		k = "searching ...";
		...
		v = new String[] { "en", "loading search results", "ar", "تحميل نتيجة البحث", "pt", "carregando resultados da busca", "pt_BR", "carregando resultados da busca", "zh", "正在加载搜索结果", "zh_HK", "載入搜尋結果", "cs", "nahrávám výsledky hledání", "nl", "resultaten ophalen", "fr", "chargement des résultats", "de", "lade Suchergebnisse", "el", "φόρτωση αποτελεσμάτων αναζήτησης", "hu", "eredmények betöltése", "it", "caricamento risultati ricerca", "pl", "wczytywanie wyników wyszukiwania", "ru",
				"загрузить результат поиска", "sk", "Načítavajú sa výsledky hľadania", "es", "cargando resultados de búsqueda" };
		p(k, v);
		k = "towns";
		...
		p(k, v);
		k = "Cancel";
		v = new String[] { "en", "Cancel", "fr", "Annulation", "de", "Abbrechen", "hu", "Mégsem", "es", "Cancelar" };
		p(k, v);
		k = "Send feedback via email ...";
		v = new String[] { "en", "Send feedback via email ...", "fr", "Envoyer commentaires par mail", "de", "Feedback per Email senden ...", "es", "Envíe sus comentarios por correo electrónico ..." };
		p(k, v);
		k = "Please press BACK again to Exit";
		v = new String[] { "en", "Please press BACK again to Exit", "fr", "Appuyer une.deuxieme fois sur retour pour sortir", "de", "nochmal BACK drücken um App zu beenden", "es", "Por favor, pulse de nuevo ATRÁS" };
		p(k, v);
		k = "google search API is not working at this moment, try offline search";
		v = new String[] { "en", "google search API is not working at this moment, try offline search", "de", "Google Suche funktioniert im Moment nicht, bitte offline Suche verwenden", "hu", "A Google keresö API nem müködik, próbáld késöbb", "es", "La búsqueda de la API de google no está funcionando en este momento, busque fuera de línea" };
		p(k, v);
		k = "saving route to GPX-file";
		v = new String[] { "en", "saving route to GPX-file", "es", "Guardando la ruta en archivo GPX" };
		p(k, v);
		k = "saving route to GPX-file failed";
		v = new String[] { "en", "saving route to GPX-file failed", "de", "saving route to GPX-file", "es", "No fue posible guardar la ruta en archivo GPX" };
		p(k, v);
		...
		p(k, v);
		k = "Destination set";
		v = new String[] { "en", "Destination set", "nl", "Bestemming ingesteld", "de", "Ziel gesetzt", "el", "Ορισμός προορισμού", "hu", "Cél beadva", "sk", "Cieľ bol určený", "es", "Conjunto de destinos" };
		p(k, v);
		k = "No route found / Route blocked";
		v = new String[] { "en", "No route found / Route blocked", "nl", "geen route gevonden", "de", "keine Route gefunden / blockiert", "el", "Δεν βέθηκε διαδρομή / μπλοκαρισμένη διαδρομή", "hu", "Nem található útvonal / útvonal lezárva", "pl", "Nie znaleziono drogi / Droga zablokowana", "sk", "Nenašla sa žiadna trasa / Trasa zablokovaná", "es", "No se encontró una ruta / Ruta bloqueada" };
		p(k, v);
		k = "Building route path";
		v = new String[] { "en", "Building route path", "de", "generiere Route Path", "hu", "Útvonal kiszámolása", "it", "Calcolando l'itinerario", "pl", "Generowanie trasy", "es", "Creando la trayectoria de la ruta" };
		p(k, v);
		k = "Building route graph";
		v = new String[] { "en", "Building route graph", "de", "generiere Route Graph", "hu", "Útvonal ábra kiszámolása", "pl", "Generowanie wykresu trasy", "sk", "Zostavuje sa graf trasy", "es", "Creando el gráfico de la ruta" };
		p(k, v);
		...
		v = new String[] { "en", "Use GSM/3g/Wireless networks for getting position (uses Internet)", "pt", "Utilizar redes GSM/3G/Sem fio para obter posição (usa a Internet)", "pt_BR", "Utilizar redes GSM/3G/Sem fio para obter posição (usa a Internet)", "zh", "使用GSM/3g/无线网路定位（需要联网）", "cs", "K získání pozice použij síť GSM/3g/WiFi (používá Internet)", "nl", "Gebruik GSM/3G/WiFi om de positie te bepalen (Internet)", "fr", "GSM/3G/Sans-fil pour déterminer la position (utilise internet)", "de",
				"Position auch mit GSM/3g/Wireless finden (braucht Internet)", "el", "Χρήση GSM/3g/Ασύρματων δυκτων για λήψη τοποθεσίας (χρήση Internet)", "hu", "GSM/3g/Wireless (Internet!) használata a pozíciómeghatározáshoz", "pl", "Użyj sieci GSM/3g/WiFi aby ustalić pozycję (wykorzystuje Internet)", "sk", "Použiť GSM/3g/Bezdrôtové siete na získanie pozície (použije Internet)" };
		p(k, v);
		...
		v = new String[] { "en", "use assisted GPS (uses Internet !!)", "zh", "使用辅助GPS（需要联网！）", "cs", "Používej asistované GPS (potřebuje Internet)", "nl", "gebruik assisted GPS (gebruikt Internet !!)", "fr", "Utilise le GPS assisté (utilise internet)", "de", "aGPS verwenden für schnellere Positionsfindung (braucht Internet !!)", "el", "χρήση aGPS (με χρήση Internet !!)", "hu", "Assisted GPS használata (internet kapcsolat!)", "pl", "Użyj assisted GPS (wykorzystuje Internet!!)", "sk",
				"Použiť asistované GPS (použije Internet !!)" };
		p(k, v);
		...
		v = new String[] { "en", "Center on GPS. activate this for Compass heading to work", "pt", "Sincronizar com GPS. Ative isso para que a bússola funcione", "pt_BR", "Sincronizar com GPS. Ative isso para que a bússola funcione", "zh", "居中显示GPS。使用罗盘导航需要激活此功能。", "cs", "Centruj mapu podle GPS. Aktivujte tuto volbu, pokud chcete používat směrování kompasem.", "nl", "Volg GPS. Benodigd voor de kompas richting", "fr", "Centré sur la position GPS, Activez cette option pour le suivi du cap", "de",
				"Karte folgt Fahrzeug", "el", "Κεντράρισμα στο GPS. ενεργοποιήστε για τη λειτουργία κατεύθυνσης πυξίδας", "hu", "A térkép követi a helyzetet (sticky)", "pl", "Podążaj za pozycją GPS. Włącz aby działał kompas.", "sk", "Centrovať na GPS. Aktivujte toto pre smerovanie podľa kompasu." };
		p(k, v);
		...
		v = new String[] { "en", "lock Vehicle on nearest Road. turn off if you are walking or driving offroad", "zh", "将汽车锁定到最近的道路。如果您是步行或越野，请关闭此选项。", "cs", "Umístnit pozici vždy na nejbližší komunikaci. Vypněte, pokud se pohybujete mimo značené trasy.", "nl", "Plaatst het voertuig op de dichtsbijzijnde weg. Zet deze uit voor wandelen of offroad rijden", "fr", "Localise exclusivement le véhicule sur les routes les plus proches à désactiver si vous marchez ou roulez hors route", "de",
				...
				"Prichytiť vozidlo k najbližšej ceste. Vypnite ak kráčate alebo jazdíte v teréne." };
		p(k, v);
		...
		v = new String[] { "en", "show vehicle in screen center, instead of the lower half", "pt", "mostra o veículo no centro da tela ao invés de exibir na parte inferior", "pt_BR", "mostra o veículo no centro da tela ao invés de exibir na parte inferior", "zh", "在屏幕居中显示汽车，而不是屏幕下半部分显示", "cs", "Zobrazuje pozici uprostřed obrazovky místo ve spodní části", "nl", "Toont het voertuig in het midden van het scherm in plaats van onderin.", "fr",
				"Affiche le véhicule au centre de l'écran, au lieu d'en bas", "de", "Fahrzeug in Displaymitte, statt weiter unten", "el", "εμφάνιση του οχήματος στο κέντρο της οθόνης, αντί για το κάτω μισό", "hu", "A pozíció a térkép közepére rögzül", "pl", "Pokaż pojazd na środku ekranu zamiast w dolnej części", "sk", "Zobraziť vozidlo v strede obrazovky, namiesto spodnej polovice" };
		p(k, v);
		k = "__PREF__title__show_sat_status";
		v = new String[] { "en", "Sat Status", "zh", "卫星状态", "cs", "Stav statelitů", "nl", "satteliet status", "fr", "Etat du GPS", "de", "Sat Status", "el", "Κατάσταση δορυφόρων", "hu", "Műholdak", "pl", "Status satelitów", "sk", "Stav satelitov" };
		p(k, v);
		...
		v = new String[] { "en", "Get direction from compass. needs lots of CPU!", "pt", "Obter direção da bússola. Exige muito da CPU!", "pt_BR", "Obter direção da bússola. Exige muito da CPU!", "zh", "从罗盘中获取方位。需要较多CPU！", "cs", "Získej směr jízdy podle kompasu. Potřebuje hodně CPU (a baterie).", "nl", "Gebruik kompas voor de richting. Kost veel CPU! De wereldweergave zal afwijken!", "fr", "Prends la direction en suivant le cap. Prends beaucoup de CPU !", "de",
				"Kompass verwenden. braucht viel CPU !!", "el", "Λήψη κατεύθυνσης από την πυξίδα. χρήση αρκετής CPU!", "hu", "Iránytű mutatása; sok CPU-t zabál!", "pl", "Ustal kierunki na podstawie kompasu. Intensywnie wykorzystuje CPU!", "sk", "Získať smer z kompasu. Veľmi zaťaží CPU!" };
		p(k, v);
		...
		v = new String[] { "en", "Get current heading from compass even at higher speeds", "pt", "Obter posição atual da bússola mesmo a altas velocidades", "pt_BR", "Obter posição atual da bússola mesmo a altas velocidades", "zh", "即使在高速行驶中也使用罗盘获取线路", "cs", "Získávej směr jizdy vždy podle kompasu a to i v případě vyšších rychlostí", "nl", "Gebruikt het kompas voor de rijrichting, ook op hoge snelheid", "fr", "Garde toujours le cap y compris à grande vitesse", "de",
				"immer Kompassrichtung verwenden", "el", "Λήψη τρέχουσας κατεύθυνσης από την πυξίδα ακόμη και σε υψηλότερες ταχύτητες", "hu", "Iránytű használata menet közben is", "pl", "Używa kompasu  nawet przy dużych prędkościach", "sk", "Získať aktuálne smerovanie z kompasu aj vo vysokej rýchlosti" };
		p(k, v);
		...
		v = new String[] { "en", "turns much smoother, WARNING: WILL EAT ALL your CPU!!", "pt", "Movimentos ficam mais suaves, CUIDADO: Utiliza TODA a CPU!", "pt_BR", "Movimentos ficam mais suaves, CUIDADO: Utiliza TODA a CPU!", "zh", "平滑转弯。警告：可能耗尽CPU！", "cs", "Kompas se točí velmi jemně. POZOR: vezme si veškerý výkon CPU", "nl", "Veel soepeler bij afslagen, WAARSCHUWING: gebruikt heel veel CPU!!!", "de", "Kompass reagiert schnell. braucht noch viel mehr CPU!!", "el",
				"πιο ήπια περιστροφή, ΠΡΟΕΙΔΟΠΟΙΗΣΗ: ΘΑ ΦΑΕΙ ΟΛΗ ΤΗΝ CPU!!", "hu", "Az iránytű gyorsítása, még több CPU-t zabál!", "pl", "Zakręty bardzo płynne. UWAGA! ZJADA CAŁĄ MOC CPU!", "sk", "Oveľa plynulejšie otáčanie, VAROVANIE: ÚPLNE ZAŤAŽÍ CPU!!" };
		p(k, v);
		...
		v = new String[] { "en", "index search", "de", "index suche", "hu", "Indexelt keresés" };
		p(k, v);
		k = "__PREF__summ__use_index_search";
		v = new String[] { "en", "use faster and better index search [donate version]", "de", "schnellere index suche verwenden [donate version]", "hu", "Indexelt keresés" };
		p(k, v);
		k = "__PREF__title__trafficlights_delay";
		v = new String[] { "en", "traffic lights", "de", "Ampeln", "el", "φανάρια", "hu", "Jelzölámpa késlekedés" };
		p(k, v);
		k = "__PREF__summ__trafficlights_delay";
		v = new String[] { "en", "set delay of traffic lights for routing", "de", "Verzögerung durch Amplen auf der Route", "el", "ορίστε την  καθυστέρηση των φαναριών για την δρομολόγηση", "hu", "Jelzölámpa késlekedés" };
		p(k, v);
		...
		v = new String[] { "en", "filter special chars", "de", "sonderzeichen filtern", "hu", "Ékezetes betük szürése" };
		p(k, v);
		k = "__PREF__summ__speak_filter_special_chars";
		v = new String[] { "en", "filter special chars when speaking streetnames", "de", "sonderzeichen beim sprechen von Straßennamen herausfiltern", "hu", "Ékezetes betük szürése" };
		p(k, v);
		k = "__PREF__title__route_style";
		v = new String[] { "en", "route style", "de", "Routenstil", "hu", "Útvonal típusa", "pl", "Styl trasy", "sk", "Štýl trasy" };
		p(k, v);
		k = "__PREF__summ__route_style";
		v = new String[] { "en", "graphic style of route", "de", "wählt den graphischen Stil wie die Route gezeichnet wird", "hu", "Útvonal típusa", "pl", "Styl rysowania trasy", "sk", "Vykreslenie trasy na mape v rôznych štýloch" };
		p(k, v);
		...
		v = new String[] { "en", "2D/3D toggle", "de", "2D/3D Knopf", "hu", "2D / 3d átkapcsolás" };
		p(k, v);
		k = "__PREF__summ__show_2d3d_toggle";
		v = new String[] { "en", "show 2D/3D toggle instead of Map off/on toggle", "de", "2D/3D Knopf statt Karte-aus-knopf anzeigen", "hu", "2D / 3d átkapcsolás" };
		p(k, v);
		...
		v = new String[] { "en", "Autozoom", "de", "Autozoom", "hu", "Automatikus zoom ki / be" };
		p(k, v);
		k = "__PREF__summ__autozoom_flag";
		v = new String[] { "en", "set map zoom automatically according to driving speed", "de", "Kartenzoom nach Fahrtgeschwindigkeit automatisch einstellen", "hu", "Automatikus zoom ki / be" };
		p(k, v);
		...
		v = new String[] { "en", "draw with AntiAlias, map is faster when this is OFF", "zh", "反走样绘制地图。关闭此选项，地图将绘制更快。", "cs", "Při vykreslování mapy použij vyhlazování čar. Je rychlejší, pokud je vypnuto.", "nl", "schakel anti aliasing in", "fr", "Afficher la carte avec de l'AntiAlias. L'affichage est plus rapide que cette option est désactivée", "de", "Antialiasing einschalten. Karte zeichnet schneller ohne Antialiasing", "el",
				"σχεδίαση με εξομάλυνση, ο χάρτης είναι πιο γρήγορος όταν δεν είναι ενεργοποιημένο", "hu", "Kontúrsimítás bekapcsolása; enélkül a térkép gyorsabb.", "pl", "Rysuj z antyaliasingiem, mapa jest szybsza, gdy to jest wyłączone", "sk", "Vykresľovať mapu s vyhladzovaním. Mapa je rýchlejšia, ak je toto vypnuté." };
		p(k, v);
		k = "__PREF__title__use_map_filtering";
		v = new String[] { "en", "filtering", "de", "filtering", "hu", "Térkép szürés" };
		p(k, v);
		k = "__PREF__summ__use_map_filtering";
		v = new String[] { "en", "filtering draws map more smoothly, but needs more CPU", "de", "filtering einschalten, zeichnet die Karte schöner. braucht aber mehr Leistung", "hu", "Térkép szürés" };
		p(k, v);
		...
		v = new String[] { "en", "smooth driving", "de", "flüssiger fahren", "pl", "Płynne przewijanie" };
		p(k, v);
		k = "__PREF__summ__use_smooth_drawing";
		v = new String[] { "en", "scroll map more smoothly when driving", "de", "verschiebt die Karte beim Fahren schöner und flüssiger, braucht jedoch mehr Leistung!", "pl", "płynne przewijanie mapy podczas jazdy" };
		p(k, v);
		k = "__PREF__title__use_more_smooth_drawing";
		v = new String[] { "en", "Even Smoother Driving", "de", "noch flüssiger fahren", "pl", "Jeszcze płynniejsze przewijanie" };
		p(k, v);
		k = "__PREF__summ__use_more_smooth_drawing";
		v = new String[] { "en", "Much smoother driving, WARNING: WILL EAT ALL your CPU!!", "de", "Verschiebt die Karte noch flüssiger. WARNUNG: braucht sehr viel Leistung!!", "pl", "Bardzo płynne przewijanie, UWAGA: ZJADA CAŁĄ MOC CPU!!" };
		p(k, v);
		k = "__PREF__title__show_multipolygons";
		v = new String[] { "en", "Multipolygons", "de", "Multipolygone", "hu", "Multipoligonok mutatása", "pl", "Wielokąty" };
		p(k, v);
		k = "__PREF__summ__show_multipolygons";
		v = new String[] { "en", "draw lines and areas from multipolygons", "de", "Multipolygone (wie Flüsse und grosse Häuser) anzeigen", "hu", "Multipoligonok mutatása", "pl", "rysuj linie i obszary za pomocą wielokątów" };
		p(k, v);
		k = "__PREF__title__show_vehicle_3d";
		v = new String[] { "en", "Vehicle 3D", "de", "3D Fahrzeug", "hu", "Jármü 3D", "pl", "Pojazd 3D" };
		p(k, v);
		k = "__PREF__summ__show_vehicle_3d";
		v = new String[] { "en", "show vehicle correctly in 3D mode", "de", "zeigt das Fahrzeug im 3D Modus perspektivisch korrekt an", "hu", "Jármü 3D", "pl", "pokazuj poprawnie pojazd w 3D" };
		p(k, v);
		k = "__PREF__title__map_font_size";
		v = new String[] { "en", "Map Font size", "zh", "地图字体大小", "de", "Karten Font Größe", "el", "Μέγεθος γραμματοσειράς χάρτη", "hu", "Térkép font méret", "pl", "Rozmiar czcionki", "sk", "Veľkosť písma na mape" };
		p(k, v);
		k = "__PREF__summ__map_font_size";
		v = new String[] { "en", "set Font size for Map Texts (streetnames, etc.)", "zh", "设置地图的字体大小（例如街道名等）", "de", "Größe der Karten Texte (Straßennamen, usw.)", "el", "μέγεθος γραμματοσειράς χάρτη (ονόματα δρόμων, κλπ.)", "hu", "A térkép betűméret beállítása", "pl", "Rozmiar czcionki na mapie (nazwy ulic itp.)", "sk", "Nastaviť veľkosť písma pre text na mape (názvy ulíc, atď.)" };
		p(k, v);
		k = "__PREF__title__drawatorder";
		v = new String[] { "en", "Draw more Detail", "zh", "绘制更多细节", "de", "Mehr Detail", "el", "Σχεδίαση περισσότερων λεπτομερειών", "hu", "Több részlet", "pl", "Więcej szczegółów", "sk", "Detailnejšie vykresľovanie" };
		p(k, v);
		k = "__PREF__summ__drawatorder";
		v = new String[] { "en", "Draw more Detail on map. change only on fast devices!", "zh", "在地图上绘制更多细节。请只在高端设备上启用。", "de", "Zeichnet mehr Details auf der Karte. Nur für schnelle Geräte!", "el", "Σχεδιάζει περισσότερες λεπτομέρειες στο χάρτη. Αλλάξτε το μόνο σε γρήγορες συσκευές.", "hu", "Részletesebb térképet rajzol. Csak gyors készülékekre!", "pl", "Więcej szczegółów na mapie. Tylko szybkie urządzenia!", "sk", "Vykresliť viac podrobností na mape. Zmenťe len na rýchlych zariadeniach!" };
		p(k, v);
		k = "__PREF__title__more_map_detail";
		v = new String[] { "en", "more Map Detail", "de", "mehr Details anzeigen", "hu", "Részletesebb térkép", "pl", "Więcej szczegółów" };
		p(k, v);
		k = "__PREF__summ__more_map_detail";
		v = new String[] { "en", "show more Map Detail [needs RESTART]", "de", "Zeigt noch mehr Details auf der Karte an, braucht aber mehr Leistung! [braucht RESTART]", "pl", "pokazuj więcej szczegółów na mapie [wymaga RESTARTU]" };
		p(k, v);
		...
		v = new String[] { "en", "Size of Mapcache [needs RESTART]", "zh", "地图缓存大小[需要重启]", "de", "Größe des Caches für Karten [braucht RESTART]", "hu", "Gyorsítótár méretének megadása (újraindítás kell!)", "pl", "Rozmiar bufora mapy (zmiana wymaga RESTARTU!)", "sk", "Veľkosť vyr. pamäte pre mapu [vyžaduje REŠTART]" };
		p(k, v);
		k = "__PREF__title__streetsearch_r";
		v = new String[] { "en", "Searchradius", "zh", "搜索半径", "de", "Suchradius", "el", "Ακτίνα αναζήτησης", "hu", "Keresésí sugár", "pl", "Promień szukania", "sk", "Rádius hľadania" };
		p(k, v);
		k = "__PREF__summ__streetsearch_r";
		v = new String[] { "en", "Searchradius for streets inside a town. Bigger radius will find streets further away from town center", "zh", "街道的搜索半径。更大的搜索半径将会搜索远离城镇中心的街道。", "de", "Suchradius für Strassen in Städten. Grösserer Radius findet Strassen die weiter vom Stadtzentrum entfernt sind", "el", "Ακτίνα αναζήτησης δρόμων μέσα σε πόλη, μεγαλύτερη ακτίνα βρίσκει δρόμους που είναι πιό μακρυά απο το κέντρο της πόλης.", "hu",
				"Nagyobb keresési sugár a városközponttól távolabbi utcákat is megtalál", "pl", "Promień szukania ulic w miastach. Większy promień pozwala znaleźć ulice położone dalej od centrum.", "sk", "Hľadací rádius pre ulice v rámci mesta. Väčší rádius nájde ulice ďalej od stredu mesta." };
		p(k, v);
		...
		v = new String[] { "en", "High DPI", "de", "High DPI", "hu", "Szükítés nagy felbontásnál" };
		p(k, v);
		...
		v = new String[] { "en", "Streets only", "de", "Nur Straßen", "hu", "Csak utcák" };
		p(k, v);
		...
		v = new String[] { "en", "Enable Debug Functions in Android Menu", "zh", "在菜单中显示调试功能", "de", "Debug Funktionen im Menü anzeigen", "el", "Ενεργοποίηση των λειτουργιών αποσφαλμάτωσης στο μενού του Android", "hu", "Engedélyezi a hibanyomkövetési funkciókat", "pl", "Włącz funkcje debugujące w menu", "sk", "Zapnúť ladiace funkcie v Android ponuke" };
		p(k, v);
		...
		v = new String[] { "en", "Select Language for messages. needs a RESTART!!", "zh", "选择界面语言。需要重启！", "cs", "Vyber komunikační jazky (pro aplikaci je nutný restart aplikace)", "nl", "Stel de taal in. Herstart is dan nodig!", "fr", "Sélection de la langue pour les messages, redémarrez l'application pour la prise en compte !!", "de", "Sprache der Applikation (Sprache und Meldungen) braucht RESTART!!", "el", "Επιλογή Γλώσσας μηνυμάτων. απαιτείται ΕΠΑΝΕΚΚΙΝΗΣΗ!!", "hu",
				"Írott és hangos nyelv kiválasztása; újraindítás szükséges", "pl", "Wybierz język komunikatów. Wymaga RESTARTU!", "sk", "Vybrať jazyk hlášok. Vyžaduje REŠTART!!" };
		p(k, v);
		...
		v = new String[] { "en", "set as Home Location", "nl", "als thuislocatie instellen", "de", "als Heimadresse setzen", "es", "Establecer como ubicación de inicio" };
		p(k, v);
		k = "Rename Destination";
		v = new String[] { "en", "Rename Destination", "ar", "إعادة تسمية المقصد", "pt", "Renomear Destino", "pt_BR", "Renomear Destino", "zh", "重命名目的地", "zh_HK", "重新命名目的地", "cs", "Přejmenovat cíl", "nl", "Bestemming hernoemen", "fr", "Renommer la destination", "de", "Ziel umbenennen", "el", "Μετονομασία Προορισμού", "hu", "Cél átnevezése", "it", "Rinomina Destinazione", "pl", "Zmień nazwę celu", "sk", "Premenovať cieľ", "es", "Renombrar destino" };
		p(k, v);
		k = "address search";
		v = new String[] { "en", "address search", "de", "Adresssuche", "es", "Búsqueda por dirección" };
		p(k, v);
		k = "Enter Destination";
		...
		p(k, v);
		k = "Housenumber";
		v = new String[] { "en", "Housenumber", "nl", "Huisnummer", "de", "Hausnummer", "hu", "Házszám", "pl", "Numer domu", "es", "Portal" };
		p(k, v);
		k = "partial match";
		...
		v = new String[] { "en", "search full mapfile [BETA]", "ca", "cerca en tot el mapa [BETA]", "ar", "بحث كل ملف الخريطة", "pt", "procurar no arquivo inteiro [BETA]", "pt_BR", "procurar no arquivo inteiro [BETA]", "zh", "搜索全部地图文件 [BETA]", "zh_HK", "搜尋完整地圖檔 [仍在測試]", "cs", "Prohledat celý mapový podklad [BETA]", "nl", "zoek op volledige kaart [BETA]", "fr", "Recherche sur toute la carte [BETA]", "de", "ganze Karte durchsuchen [BETA]", "el", "αναζήτηση σε όλο το χάρτη [BETA]", "hu",
				"Teljes adatbázis keresése [BETA]", "it", "cerca file mappa completo [BETA]", "pl", "przeszukaj cały plik map [BETA]", "sk", "Prehľadávať celý mapový súbor [BETA]", "es", "buscar en todo el mapa [BETA]" };
		p(k, v);
		k = "last searches";
		...
		v = new String[] { "en", "Address or POI-Name", "de", "Adresse oder POI-Name", "hu", "Cím vagy POI-név", "es", "Dirección del nombre del punto de interés" };
		p(k, v);
		k = "Stop map download?";
		...
		v = new String[] { "en", "press HOME to download in the background", "de", "drücke HOME um die Karten im Hintergrund zu laden", "es", "pulsar HOME para descargar en segundo plano" };
		p(k, v);
		k = "Enter your Feedback text";
		v = new String[] { "en", "Enter your Feedback text", "de", "Feedbacktext eingeben", "hu", "Vélemény beírása", "es", "Introduzca el texto en Comentarios" };
		p(k, v);
		k = "send";
		v = new String[] { "en", "send", "nl", "verzend", "fr", "envoyer", "de", "senden", "hu", "Küldés", "es", "enviar" };
		p(k, v);
		k = "copy Bitcoinaddress to Clipboard";
		v = new String[] { "en", "copy Bitcoinaddress to Clipboard", "de", "Bitcoin Adresse in Zwischenablage kopieren", "es", "Copiar la dirección bitcoin en el portapapeles" };
		p(k, v);
		k = "send Bitcoinaddress and QR Code as Email";
		v = new String[] { "en", "send Bitcoinaddress and QR Code as Email", "de", "Bitcoin Adresse und QR Code als Email senden", "es", "enviar la dirección Bitcoin y el Código QR por Email" };
		p(k, v);
		k = "Donate with Bitcoin Wallet App";
		v = new String[] { "en", "Donate with Bitcoin Wallet App", "de", "Spende mit Bitcoin Wallet App", "es", "Donar con Bitcoin Wallet App" };
		p(k, v);
		k = "ZANavi Donation with Bitcoin";
		v = new String[] { "en", "ZANavi Donation with Bitcoin", "de", "ZANavi Spenden mit Bitcoin", "es", "Donar a ZANavi con Bitcoin" };
		p(k, v);
		k = "Bitcoin address";
		v = new String[] { "en", "Bitcoin address", "fr", "Adresse Bitcoin", "de", "Bitcoin Adresse", "es", "Dirección Bitcoin" };
		p(k, v);
		k = "generate QR code";
		v = new String[] { "en", "generate QR code", "nl", "QR code genereren", "de", "generiere QR Code", "es", "Generar un código QR" };
		p(k, v);
		k = "Send Bitcoin address to email ...";
		v = new String[] { "en", "Send Bitcoin address to email ...", "de", "sende Bitcoin Adresse als Email ...", "es", "Enviar la dirección Bitcoin por email" };
		p(k, v);
		k = "Bitcoinaddress copied to Clipboard";
		v = new String[] { "en", "Bitcoinaddress copied to Clipboard", "de", "Bitcoin Adresse in Zwischenablage kopiert", "es", "La dirección Bitcoin se copió en el portapapeles" };
		p(k, v);
		...
		p(k, v);
		k = "Click to talk";
		v = new String[] { "en", "Click to talk", "de", "zum sprechen drücken", "hu", "Beszélgetéshez katt ide", "es", "Pulse aquí para hablar" };
		p(k, v);
		k = "Voice Search, speak your Destination";
		v = new String[] { "en", "Voice Search, speak your Destination", "de", "Sprachsuche", "hu", "Hang alapú keresés, mondd a célt", "es", "Búsqueda por voz, diga su Destino" };
		p(k, v);
		k = "Google Speechrecognition not found";
		v = new String[] { "en", "Google Speechrecognition not found", "de", "Google Text-in-Sprache nicht installiert", "hu", "Nem találom a Google beszédfelismeröt!", "es", "No se ha encontrado el reconocimiento por voz de google" };
		p(k, v);
		k = "you said:";
		...
		p(k, v);
		k = "Find Destination";
		v = new String[] { "en", "Find Destination", "de", "Ort finden", "hu", "Hely keresése", "es", "Buscar destino" };
		p(k, v);
		k = "Google did not find this location. Please search again";
		v = new String[] { "en", "Google did not find this location. Please search again", "de", "Dieser Ort wurde von Google nicht gefunden. Bitte versuchen Sie es nochmals", "hu", "A Google nem találja azt a helyet. Keress újra!", "es", "Google no encontró esta ubicación. Por favor, busque de nuevo" };
		p(k, v);
		k = "What's here";
		v = new String[] { "en", "What's here", "de", "Was ist hier", "el", "Τι είναι εδώ", "hu", "Mi van itt?", "pl", "Co tu jest", "sk", "Čo je tu", "es", "¿Que hay aquí?" };
		p(k, v);
		// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
		// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
		// change those in https://translations.launchpad.net/zanavi
