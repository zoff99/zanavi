...
public class NavitTextTranslations
{
	...
	public static void init()
	{
		...
		// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
		k = "Donate";
		v = new String[] { "en", "Donate", "fr", "Faites un don", "de", "Spenden", "el", "Δωρεά", "sk", "Prispieť" };
		p(k, v);
		k = "buy Donate Version";
		v = new String[] { "en", "buy Donate Version", "pt_BR", "comprar Versão de Doação", "fr", "Achetez la version payante", "de", "Donate Version kaufen", "el", "αγορά έκδοσης Με δωρεά", "es", "Quiero donar para la versión" };
		p(k, v);
		...
		v = new String[] { "en", "Donate with the offcial Donate App", "pt_BR", "Doar com o Aplicativo oficial de Doação", "de", "offizielle Spenden App starten", "el", "Δωρεά μέσω της επίσημης εφρμογής Δωρεάς", "es", "Donar para la App oficial" };
		p(k, v);
		...
		v = new String[] { "en", "ZANavi Donate Version already installed", "pt_BR", "ZANavi Versão de Doação já instalada", "de", "Donate Version ist bereits installiert", "el", "Η έκδση του ZANavi με Δωρεά είναι ήδη εγκατεστημένη", "es", "La versión donada de Zanavi, ya está instalada" };
		p(k, v);
		k = "ZANavi large map Donate Version already installed";
		v = new String[] { "en", "ZANavi large map Donate Version already installed", "pt_BR", "ZANavi mapa grande Versão de Doação já instalada", "de", "large-map Donate Version ist bereits installiert", "el", "Η έκδοση ολόκληρου-χάρτη με Δωρεά είναι ήδη εγκατεστημένη", "es", "La versión larga del mapa donado, ya está instalado" };
		p(k, v);
		k = "There is no Donate App on Amazon-device";
		v = new String[] { "en", "There is no Donate App on Amazon-device", "pt_BR", "Não há Aplicação de Doação no dispositivo-Amazon", "de", "Auf dem Amazongerät gibt es keine Donate App", "el", "Δεν υπάρχει εφαρμογή Δωρεάς στή συσκευή-Amazon" };
		p(k, v);
		...
		v = new String[] { "en", "show destination on map", "ca", "mostrar destinació al mapa", "ar", "عرض المقصد علي الخريطة", "pt", "mostrar destino no mapa", "pt_BR", "mostrar destino no mapa", "zh", "在地图上显示目的地", "zh_HK", "於地圖顯示目的地", "cs", "zobrazit cíl na mapě", "nl", "toon bestemming op kaart", "fr", "afficher la destination sur la carte", "de", "Ziel auf Karte anzeigen", "el", "εμφάνιση προορισμού στο χάρτη", "hu", "Mutasd az úticélt a térképen", "it", "mostra destinazione sulla mappa",
				"pl", "pokaż cel na mapie", "ru", "показать пункт назначения на карте", "sk", "Zobraziť cieľ na mape", "es", "mostrar destino en el mapa" };
		p(k, v);
		k = "touch map to zoom";
		...
		p(k, v);
		k = "Mapdownload";
		v = new String[] { "en", "Mapdownload", "ar", "تحميل الخريطة", "pt", "Baixar mapa", "pt_BR", "Baixar mapa", "zh", "地图下载", "zh_HK", "地圖下載", "cs", "Stahování mapy", "nl", "kaart download", "fr", "Téléchargement de carte", "de", "Kartendownload", "el", "Λήψη χάρτη", "hu", "Térképletöltés", "it", "Scarica mappa", "pl", "Pobieranie map", "ru", "загрузка карты", "sk", "Sťahovanie mapy", "es", "Descargar mapa" };
		p(k, v);
		k = "downloading";
		...
		v = new String[] { "en", "Enter: City and Street", "ar", "أدخل: المدينة و الشارع", "pt", "Informe: Cidade e Rua", "pt_BR", "Informe: Cidade e Rua", "zh", "输入：城市和街道", "zh_HK", "輸入：城市及街道", "cs", "Vložte: město a ulici", "nl", "Invoer: plaatsnaam en straat", "de", "Stadt und Straße:", "el", "Εισαγωγή: Πόλη και Οδός", "hu", "Város, utca:", "it", "Città e Via", "pl", "Wprowadź: Miasto oraz Ulica", "ru", "Ввести: Город и Улицу", "sk", "Zadjate: Mesto a ulicu", "es",
