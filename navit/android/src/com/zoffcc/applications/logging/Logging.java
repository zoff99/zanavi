...
public class Logging
{
	...
	private static String grabLogcat()
	{
		try
		{
			...
			final Process process = Runtime.getRuntime().exec("logcat -d " + "EasyPermissions:D " + "Navit:D " + "navit:D " + "NavitGraphics:D " + "NavitMapDownloader:D " + "NavitOSDJava:D " + "NavitPlugin:D " + "NavitSpeech2:D " + "NavitTextTranslations:D " + "NavitVehicle:D " + "NavitWatch:D " + "PlayServices:D " + "System.out:I AndroidRuntime:E *:S");
	...
	private static String buildDescription(Context context)
	{
		...
		try
		{
			pkgInfo = context.getPackageManager().getPackageInfo("com.zoffcc.applications.zanavi_msg", 0);
			builder.append("Plugin  : ").append(pkgInfo.packageName).append(":").append(pkgInfo.sharedUserId).append(":").append(pkgInfo.versionCode).append("\n");
		}
		catch (Exception e)
		{
			e.printStackTrace();
